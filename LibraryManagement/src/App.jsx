...
function App() {
  ...
  return (
    <>
      ...
      {page === "About" && <About />}
      {page === "Login" && (
        <Login setPage={setPage} onLoggedIn={handleLoggedIn} />
      )}
      {page === "Register" && (
        <Register setPage={setPage} onLoggedIn={handleLoggedIn} />
      )}
      {page === "MyReservations" && (
        <MyReservations
          focusBookId={focusBookId}
          onClearFocus={() => setFocusBookId(null)}
        />
      )}
      {page === "MyDonations" && (
        <MyDonations
