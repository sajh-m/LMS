...
function MyReservations({ focusBookId, onClearFocus }) {
  ...
  const handleReceive = async (id) => {
    if (
      !confirm(
        "Confirm you physically received this book? This permanently removes the listing.",
      )
    )
      return;
    setError(null);
    ...
    <div className="my-reservations-page">
      ...
      {focusBookId && (
        <div className="focus-banner">
          ...
          <button className="focus-clear-btn" onClick={onClearFocus}>
            Show All
          </button>
        </div>
      )}
